...
const C = (() => {
  ...
  const BEAUTY = {
    makeup:[
      {t:'瓜子脸/圆脸 通勤妆',s:'日常通勤 · 自然裸妆感',src:'抖音 @陈圆圆超可爱',col:'💄'},
      {t:'日常淡妆教程',s:'清透伪素颜',src:'抖音 @一一只是黑猫',col:'💄'},
      {t:'约会甜美妆',s:'粉嫩元气 · 约会必看',src:'抖音 @麻辣烫',col:'💄'},
    ],
    dress:[
      {t:'小个显高穿搭',s:'上短下长 · 同色系延伸',src:'抖音 @一一只是黑猫',col:'👗'},
      {t:'甜酷日常风',s:'扬长避短搭配思路',src:'抖音 @麻辣烫',col:'👗'},
      {t:'圆脸显瘦发型妆容',s:'修饰脸型',src:'抖音 @陈圆圆超可爱',col:'👗'},
    ]
  };
